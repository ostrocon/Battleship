"""
    ...
    Constructor Method for the Battleship class
    Attributes:
...
class Ships:
    ...
    """Constructor Method for the spaceship class using __init__"""
    def __init__(self):
        self.name = 'default'
        self.health = 1000.0
        self.shield = 100.0
    ...
    hit function also has a nested function called miss_attack which if a one is passed in rolled argument of hit then 
    nothing will happen to health and shield and if any other number then a shield or health will decrease. """

    def battleship_art(self):
        print('                                     # #  ( )')
        print('                                 ____#_#___|__')
    ...
    def hit(self, other_ship, rolled):
        def miss_attack(rolled_hit):
            ...
            if (rolled_hit == 0) or (rolled_hit > 1):
